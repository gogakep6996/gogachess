 ...
 *  Тройка мешала работе: учитель расписывает турниры на неделю вперёд и упирался
 *  в лимит на четвёртом. Порог поднят до уровня, которого живой человек не
 *  достигает, но который не даёт скрипту засыпать список тысячей турниров. */
const MAX_OPEN_PER_USER = 30;
