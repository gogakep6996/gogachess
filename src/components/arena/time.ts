 ...
 *  В серверной разметке результат показывать нельзя: к моменту оживления
 *  страницы в браузере время уже другое, и React жалуется на несовпадение.
 *  На таких страницах отсчёт прячут до первого эффекта (см. ArenaTimer). */
